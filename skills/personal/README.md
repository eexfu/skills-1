...
- **[externalized-learning](./externalized-learning/SKILL.md)** — Build and maintain externalized knowledge for the agent across sessions, extracted from conversations and external sources.
...
- **[zoom-out](./zoom-out/SKILL.md)** — Zoom out and give broader context or a higher-level perspective on unfamiliar code.
